                ...
                <div className={styles.text}>
                    ...
                    <div className={styles.codeBlock}>
                        ...
                        <div className={styles.codeContent}>
                            ...
                            <p className={styles.codeLine}>
                                &nbsp;&nbsp;<span className={styles.codeKey}>Apresentação:</span> <span className={styles.codeString}>"Proativo"</span>, <span className={styles.codeString}>"Tenho foco em criar soluções funcionais e bem estruturadas, sempre
                                    buscando aprender novas tecnologias e contribuir para projetos colaborativos.
                                    Fluente em inglês e com perfil proativo e adaptável.
                                    "</span>
                            </p>
                            <p className={styles.codeLine}>
                                &#125;;
